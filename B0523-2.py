...
l1 = Label(window, text="화씨", font = "나눔명조 14") # font = "폰트명 글자크기"
l2 = Label(window, text="섭씨", font = "나눔명조 14")
l1.grid(row=0, column=0) # grid : 표 만들기
l2.grid(row=1, column=0)

e1 = Entry(window, bg = "lightgray", fg = "red") # bg = "색깔" : 네모박스 안에 색깔 / fg = "색깔" : 글자색깔
e2 = Entry(window, bg = "lightgray", fg = "blue")
